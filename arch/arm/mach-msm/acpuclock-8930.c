...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[15] = { { 1188000, HFPLL, 1, 0x2C }, LVL_HIGH, 1150000, 7 },
		...
		[20] = { { 1458000, HFPLL, 1, 0x36 }, LVL_HIGH, 1150000, 7 },
		[21] = { { 1512000, HFPLL, 1, 0x38 }, LVL_HIGH, 1150000, 7 },
	#endif
	{ }
};
...
static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
	...
	{ 1, {  1188000, HFPLL, 1, 0x2C }, L2(15), 1200000 },
		...
		{ 1, {  1890000, HFPLL, 1, 0x40 }, L2(21), 1285000 },
		{ 1, {  1944000, HFPLL, 1, 0x42 }, L2(21), 1285000 },
	#endif
	#ifdef CONFIG_CPU_OC_20
		{ 1, {  2000000, HFPLL, 1, 0x44 }, L2(21), 1300000 },
	#endif
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_fast[] __initdata = {
	...
	{ 1, {  1188000, HFPLL, 1, 0x2C }, L2(15), 1125000 },
		...
		{ 1, {  1890000, HFPLL, 1, 0x40 }, L2(21), 1210000 },
		{ 1, {  1944000, HFPLL, 1, 0x42 }, L2(21), 1225000 },
	#endif
	#ifdef CONFIG_CPU_OC_20
		{ 1, {  2000000, HFPLL, 1, 0x44 }, L2(21), 1240000 },
	#endif
	{ 0, { 0 } }
};
